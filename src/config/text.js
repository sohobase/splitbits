export default {
  EN: {
    ...
    CHOOSE_YOUR_WALLET: 'choose one of your wallets',
    ...
    UNKNOWN: 'Unknown',
    UNSECURED_CONNECTION: 'You are using an unsecured WIFI connection.',
  ...
  ES: {
    ...
    UNKNOWN: 'Desconocido',
    UNSECURED_CONNECTION: 'Estás utilizando una conexión WIFI no segura.',
